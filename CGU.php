...
<p>Dernière mise à jour : 08 avril 2021</p>
...
<h2>Définitions</h2>
<p>Pour les besoins de la présente politique de confidentialité :</p>
<ul>
    <li>
    ...
    <li>
        </p><strong>Les cookies</strong> sont de petits fichiers placés sur votre ordinateur, votre appareil mobile ou tout autre appareil par un site web, contenant les détails de votre historique de navigation sur ce site web parmi ses nombreuses utilisations.</p>
        <p>.
    </li>
    <li>
    ...
    <li>
        <p><strong>Données personnelles</strong> désigne toute information qui se rapporte à une personne physique identifiée ou identifiable.</p>
    </li>
    <li>
    ...
    <li>
        <p><strong>Fournisseur de services</strong> désigne toute personne physique ou morale qui traite les données pour le compte de la Société. Il s'agit de sociétés tierces ou de personnes employées par la Société pour faciliter le Service, pour fournir le Service au nom de la Société, pour exécuter des services liés au Service ou pour aider la Société à analyser la façon dont le Service est utilisé.</p>
        <p>.
    </li>
    <li>
        <p><strong>Service de médias sociaux tiers</strong> désigne tout site web ou tout site web de réseau social par le biais duquel un utilisateur peut se connecter ou créer un compte pour utiliser le Service.</p>
    </li>
    <li>
        </p><strong>Données d'utilisation</strong> désigne les données collectées automatiquement, soit générées par l'utilisation du Service, soit provenant de l'infrastructure du Service elle-même (par exemple, la durée de visite d'une page).</p>
        <p>.
    </li>
    <li>
...
<p>Lorsque vous utilisez notre service, nous pouvons vous demander de nous fournir certaines informations personnellement identifiables qui peuvent être utilisées pour vous contacter ou vous identifier. Les informations personnellement identifiables peuvent inclure, mais ne sont pas limitées à :</p>
<ul>
    <li>
...
<ul>
    <li><strong>Cookies ou cookies de navigateur.</strong> Un cookie est un petit fichier placé sur Votre appareil. Vous pouvez demander à Votre navigateur de refuser tous les Cookies ou d'indiquer quand un Cookie est envoyé. Cependant, si Vous n'acceptez pas les Cookies, Vous ne pourrez peut-être pas utiliser certaines parties de notre Service. À moins que vous n'ayez réglé les paramètres de votre navigateur pour qu'il refuse les Cookies, notre Service peut utiliser des Cookies.</li>
    <li><strong>Cookies Flash.</strong> Certaines fonctionnalités de notre Service peuvent utiliser des objets stockés localement (ou Cookies Flash) pour collecter et stocker des informations sur vos préférences ou votre activité sur notre Service. Les Cookies Flash ne sont pas gérés par les mêmes paramètres de navigateur que ceux utilisés pour les Cookies de navigateur. Pour plus d'informations sur la manière dont vous pouvez supprimer les cookies Flash, veuillez lire &quot;Où puis-je modifier les paramètres de désactivation ou de suppression des objets locaux partagés?&quot ; disponible sur <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" rel="external nofollow noopener" target="_blank">https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_share.
            d_objets_</a></li>.
...
<p>Les cookies peuvent être des cookies &quot;persistants&quot ; ou des cookies &quot;de session&quot ;. Les Cookies persistants restent sur votre ordinateur personnel ou votre appareil mobile lorsque vous vous déconnectez, tandis que les Cookies de session sont supprimés dès que vous fermez votre navigateur web. En savoir plus sur les cookies : <a href="https://www.privacypolicies.com/blog/cookies/" target="_blank">Qu'est-ce que les cookies ? </a>.</p>
...
<ul>
    ...
    <li>
        ...
        <p>Objectif : Ces Cookies nous permettent de mémoriser les choix que Vous faites lorsque Vous utilisez le Site Internet, comme la mémorisation de vos données de connexion ou de votre préférence linguistique. L'objectif de ces Cookies est de Vous fournir une expérience plus personnelle et de Vous éviter de devoir saisir à nouveau vos préférences chaque fois que Vous utilisez le Site Internet.</p>
        <p>.